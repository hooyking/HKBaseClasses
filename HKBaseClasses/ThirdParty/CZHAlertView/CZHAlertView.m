...
@interface CZHAlertView ()<UIGestureRecognizerDelegate>
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch {
    ...
    if (CGRectContainsPoint(self.wholeContainerView.frame, pointPosition)) {
        return NO;
    }
    return YES;
}
...
- (void)czh_calculateFrameForActionSheet {
    ...
    _wholeContainerView.frame = CGRectMake(wholeContainerViewX, wholeContainerViewY, wholeContainerViewW, wholeContainerViewH+(kSecurityH > 0 ? kSecurityH-15 : 0));
