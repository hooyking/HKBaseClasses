...
+ (instancetype)defaultConfiguration {
    return [CWLateralSlideConfiguration configurationWithDistance:kCWSCREENWIDTH * (kIPhone5Series ? 0.9 : 0.8) maskAlpha:0.3 scaleY:1.0 direction:CWDrawerTransitionFromLeft backImage:nil];
}
