...
//    NSLayoutConstraint *contraint1 = [NSLayoutConstraint constraintWithItem:cancelButton attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:bezelView attribute:NSLayoutAttributeTop multiplier:1.0 constant:0];
//    //子view的左边缘离父view的左边缘40个像素
//    NSLayoutConstraint *contraint2 = [NSLayoutConstraint constraintWithItem:cancelButton attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:bezelView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:0];
//    //子view的下边缘离父view的下边缘40个像素
//    NSLayoutConstraint *contraint3 = [NSLayoutConstraint constraintWithItem:cancelButton attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeBottom multiplier:1.0 constant:250];
//    //子view的右边缘离父view的右边缘40个像素
//    NSLayoutConstraint *contraint4 = [NSLayoutConstraint constraintWithItem:cancelButton attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeRight multiplier:1.0 constant:250];
//    //把约束添加到父视图上
//    NSArray *array = [NSArray arrayWithObjects:contraint1,contraint2,contraint3,contraint4, nil];
//    [bezelView addConstraints:array];
